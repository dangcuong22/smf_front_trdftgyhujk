        ...
        <Row>
          <Col>
            <Card className="flex-fill ">
              ...
              <Row>
                  <Col xs='1'>
                      <div className='warning__statistic' style={{"backgroundColor":"red"}}></div>
                  </Col>
                  <Col xs='3'>
                  ...
                  <Col xs='1'>
                      <div className='warning__statistic'  style={{"backgroundColor":"orange"}}></div>
                  </Col>
                  <Col xs='3'>
                      <h3 className='mt-2 font-weight-bold'>
                          Thấp
        ...
        <Row>
                ...
                <Media>
                  ...
                  <Media body>
                    <UncontrolledPopover placement="left" target="L1" trigger="hover" style={{width:"150px"}}>
                      ...
                      <PopoverBody>
                        Tín hiệu truyền:<h6 className={this.ConvertStatus(L1.RF_signal)}> {L1.RF_signal === null ? null : L1.RF_signal}</h6><br/>
                        Dung lượng pin:<h6 className="text-success d-inline"> {L1.battery === null ? null : L1.battery + "%"} </h6>
                      </PopoverBody>
                    </UncontrolledPopover>
                ...
                <Media>
                  ...
                  <Media body>
                    <UncontrolledPopover placement="left" target="L2" trigger="hover" style={{width:"150px"}}>
                      <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                      <PopoverBody>
                        Tín hiệu truyền:<h6 className={this.ConvertStatus(L2.RF_signal)}> {L1.RF_signal === null ? null : L2.RF_signal}</h6><br/>
                        Dung lượng pin:<h6 className="text-success d-inline"> {L2.battery === null ? null : L2.battery + "%"} </h6>
                      </PopoverBody>
                    </UncontrolledPopover>
          ...
          <Col sm="3">
            <Card className="flex-fill">
              <CardHeader className="border border-primary px-2 !important">
                <div className="float-right">
                  <img src={PH} width={50} height={50} alt="sensor"/>
                </div>
                ...
                <Media>
                  ...
                  <Media body>
                    <UncontrolledPopover placement="left" target="PH1" trigger="hover" style={{width:"150px"}}>
                      <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                      <PopoverBody>
                        Tín hiệu truyền:<h6 className={this.ConvertStatus(PH1.RF_signal)}> {L1.RF_signal === null ? null : PH1.RF_signal}</h6><br/>
                        Dung lượng pin:<h6 className="text-success d-inline"> {PH1.battery === null ? null : PH1.battery + "%"} </h6>
                      </PopoverBody>
                    </UncontrolledPopover>
                ...
                <Media>
                  ...
                  <Media body>
                    <UncontrolledPopover placement="left" target="PH2" trigger="hover" style={{width:"150px"}}>
                      <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                      <PopoverBody>
                        Tín hiệu truyền:<h6 className={this.ConvertStatus(PH2.RF_signal)}> {L1.RF_signal === null ? null : PH2.RF_signal}</h6><br/>
                        Dung lượng pin:<h6 className="text-success d-inline"> {PH2.battery === null ? null : PH2.battery + "%"} </h6>
                      </PopoverBody>
                    </UncontrolledPopover>
                ...
                <Media>
                  ...
                  <Media body>
                    <UncontrolledPopover placement="left" target="T1" trigger="hover" style={{width:"150px"}}>
                      <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                      <PopoverBody>
                        Tín hiệu truyền:<h6 className={this.ConvertStatus(T1.RF_signal)}> {T1.RF_signal === null ? null : T1.RF_signal}</h6><br/>
                        Dung lượng pin:<h6 className="text-success d-inline"> {T1.battery === null ? null : T1.battery + "%"} </h6>
                      </PopoverBody>
                    </UncontrolledPopover>
                ...
                <Media>
                  ...
                  <Media body>
                    <UncontrolledPopover placement="left" target="T2" trigger="hover" style={{width:"150px"}}>
                      <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                      <PopoverBody>
                        Tín hiệu truyền:<h6 className={this.ConvertStatus(T2.RF_signal)}> {T2.RF_signal === null ? null : T2.RF_signal}</h6><br/>
                        Dung lượng pin:<h6 className="text-success d-inline"> {T2.battery === null ? null : T2.battery + "%"} </h6>
                      </PopoverBody>
                    </UncontrolledPopover>
                ...
                <Media>
                  ...
                  <Media body>
                    <UncontrolledPopover placement="left" target="HZ" trigger="hover" style={{width:"150px"}}>
                      <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                      <PopoverBody>
                        Tín hiệu truyền:<h6 className={this.ConvertStatus(H1.RF_signal)}> {H1.RF_signal === null ? null : H1.RF_signal}</h6><br/>
                        Dung lượng pin:<h6 className="text-success d-inline"> {H1.battery === null ? null : H1.battery + "%"} </h6>
                      </PopoverBody>
                    </UncontrolledPopover>
                ...
                <Media>
                  ...
                  <Media body>
                    <UncontrolledPopover placement="left" target="H2" trigger="hover" style={{width:"150px"}}>
                      <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                      <PopoverBody>
                        Tín hiệu truyền:<h6 className={this.ConvertStatus(H2.RF_signal)}> {H2.RF_signal === null ? null : H2.RF_signal}</h6><br/>
                        Dung lượng pin:<h6 className="text-success d-inline"> {H2.battery === null ? null : H2.battery + "%"} </h6>
                      </PopoverBody>
                    </UncontrolledPopover>
                    ...
                    <Media>              
                      <Media body>
                        ...
                        <UncontrolledPopover placement="left" target="SM1" trigger="hover" style={{width:"150px"}}>
                          <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                          <PopoverBody>
                            Tín hiệu truyền:<h6 className={this.ConvertStatus(SM1.RF_signal)}> {SM1.RF_signal === null ? null : SM1.RF_signal}</h6><br/>
                            Dung lượng pin:<h6 className="text-success d-inline"> {SM1.battery === null ? null : SM1.battery + "%"} </h6>
                          </PopoverBody>
                        </UncontrolledPopover>
                    ...
                    <Media>
                      <Media body>
                        ...
                        <UncontrolledPopover placement="left" target="SM2" trigger="hover" style={{width:"150px"}}>
                          <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                          <PopoverBody>
                            Tín hiệu truyền:<h6 className={this.ConvertStatus(SM2.RF_signal)}> {SM1.RF_signal === null ? null : SM2.RF_signal}</h6><br/>
                            Dung lượng pin:<h6 className="text-success d-inline"> {SM2.battery === null ? null : SM2.battery + "%"} </h6>
                          </PopoverBody>
                        </UncontrolledPopover>
                    ...
                    <Media>
                      <Media body>
                        ...
                        <UncontrolledPopover placement="left" target="SM3" trigger="hover" style={{width:"150px"}}>
                            <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                            <PopoverBody>
                              Tín hiệu truyền:<h6 className={this.ConvertStatus(SM3.RF_signal)}> {SM3.RF_signal === null ? null : SM3.RF_signal}</h6><br/>
                              Dung lượng pin:<h6 className="text-success d-inline"> {SM3.battery === null ? null : SM3.battery + "%"} </h6>
                            </PopoverBody>
                        </UncontrolledPopover>
                    ...
                    <Media>
                      <Media body>
                        ...
                        <UncontrolledPopover placement="left" target="SM4" trigger="hover" style={{width:"150px"}}>
                            <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                            <PopoverBody>
                              Tín hiệu truyền:<h6 className={this.ConvertStatus(SM4.RF_signal)}> {SM4.RF_signal === null ? null : SM4.RF_signal}</h6><br/>
                              Dung lượng pin:<h6 className="text-success d-inline"> {SM4.battery === null ? null : SM4.battery + "%"} </h6>
                            </PopoverBody>
                        </UncontrolledPopover>
                    ...
                    <Media>
                      <Media body>
                        ...
                        <UncontrolledPopover placement="left" target="SM5" trigger="hover" style={{width:"150px"}}>
                            <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                            <PopoverBody>
                              Tín hiệu truyền:<h6 className={this.ConvertStatus(SM5.RF_signal)}> {SM5.RF_signal === null ? null : SM5.RF_signal}</h6><br/>
                              Dung lượng pin:<h6 className="text-success d-inline"> {SM5.battery === null ? null : SM5.battery + "%"} </h6>
                            </PopoverBody>
                        </UncontrolledPopover>
                  ...
                  <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM6" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                            Tín hiệu truyền:<h6 className={this.ConvertStatus(SM6.RF_signal)}> {SM6.RF_signal === null ? null : SM6.RF_signal}</h6><br/>
                            Dung lượng pin:<h6 className="text-success d-inline"> {SM6.battery === null ? null : SM6.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                  ...
                  <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM7" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM7.RF_signal)}> {SM7.RF_signal === null ? null : SM7.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM7.battery === null ? null : SM7.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                  ...
                  <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM8" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM8.RF_signal)}> {SM8.RF_signal === null ? null : SM8.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM8.battery === null ? null : SM8.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                  ...
                  <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM9" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM9.RF_signal)}> {SM9.RF_signal === null ? null : SM9.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM9.battery === null ? null : SM9.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                  ...
                  <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM10" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM10.RF_signal)}> {SM10.RF_signal === null ? null : SM10.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM10.battery === null ? null : SM10.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                 ...
                 <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM11" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM11.RF_signal)}> {SM11.RF_signal === null ? null : SM11.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM11.battery === null ? null : SM11.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                  ...
                  <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM12" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM12.RF_signal)}> {SM12.RF_signal === null ? null : SM12.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM12.battery === null ? null : SM12.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                  ...
                  <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM13" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM13.RF_signal)}> {SM13.RF_signal === null ? null : SM13.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM13.battery === null ? null : SM13.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                  ...
                  <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM14" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM10.RF_signal)}> {SM14.RF_signal === null ? null : SM14.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM14.battery === null ? null : SM14.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                  ...
                  <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM15" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM15.RF_signal)}> {SM15.RF_signal === null ? null : SM15.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM15.battery === null ? null : SM15.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                 ...
                 <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM16" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM16.RF_signal)}> {SM16.RF_signal === null ? null : SM16.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM16.battery === null ? null : SM16.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                  ...
                  <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM17" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM17.RF_signal)}> {SM17.RF_signal === null ? null : SM17.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM17.battery === null ? null : SM17.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                  ...
                  <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM18" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM18.RF_signal)}> {SM18.RF_signal === null ? null : SM18.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM18.battery === null ? null : SM18.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                  ...
                  <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM19" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM19.RF_signal)}> {SM19.RF_signal === null ? null : SM19.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM19.battery === null ? null : SM19.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
                  ...
                  <Media>
                    <Media body>
                      ...
                      <UncontrolledPopover placement="left" target="SM20" trigger="hover" style={{width:"150px"}}>
                        <PopoverHeader>Thông tin cảm biến</PopoverHeader>
                        <PopoverBody>
                          Tín hiệu truyền:<h6 className={this.ConvertStatus(SM20.RF_signal)}> {SM20.RF_signal === null ? null : SM20.RF_signal}</h6><br/>
                          Dung lượng pin:<h6 className="text-success d-inline"> {SM20.battery === null ? null : SM20.battery + "%"} </h6>
                        </PopoverBody>
                      </UncontrolledPopover>
